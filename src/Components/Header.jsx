	...
	return (
		<div className='bg-primary flex flex-col md:flex-row  rounded-lg px-6 md:px-10 lg:px-20'>
			<div className=' md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] '>
				...
				<a href="#speciality" className=' bg-white text-sm flex items-center md:m-0 hover:scale-105 transition-all duration-300 rounded-full gap-2 m-auto text-gray-600 py-3 px-8'>
